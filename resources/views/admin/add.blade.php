    ...
    <div class="wedo" style="margin: 120px 0px 60px 0px;">
        <div class="container">
            <div class="row">
                ...
                <form action="{{ url('product') }}" method="POST" style="margin: 20px 100px 40px 200px; width: 760px;"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3" <label for="exampleFormControlInput1" class="form-label">Email
                        address</label>
                        <input type="email" name="email" class="form-control" id="exampleFormControlInput1"
                            placeholder="admin@otofix.test" disabled>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="button"
                        style="width: 300px;margin: 20px 0px 20px 240px; background-color: #4572E9;"
