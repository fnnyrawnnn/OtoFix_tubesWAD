               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo">
                           <a href="home"><img src="{{ asset('assets/images/otofix_logo.png') }}" alt="#" style="width: 136px" /></a>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-md-3">
                     <div class="wsk-cp-product">
                        ...
                        <div class="wsk-cp-text">
                           ...
                           <div class="category">
                              <a href="#" style="background-color: red;"><span>Delete</span></a>
                           </div>
                           ...
                           <div class="card-footer">
                              <div class="wcf-left"><span class="price">"{{ $prod->distance }}" from your Location</span></div>
                           </div>
                        </div>
                     </div>
                  </div>
